        ...
        child: Column(
          children: [
            ...
            PreferencesListTile(
              titleText: "Marketing",
              subtitleTxt:
                  "Maarketing cookies collec information about your use of this and"
                      " other apps to enable display ads and other marketing that is more relevant to you.",
              isActive: false,
              press: () {},
            ),
            const Divider(height: defaultPadding * 2),
            PreferencesListTile(
              ...
              subtitleTxt:
                  "These cookies are set by a range of social media services that we have "
                      "added to the site to enable you to share our content with your friends and networks.",
              isActive: false,
              press: () {},
            ),
          ],
